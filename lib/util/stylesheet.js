...
StyleSheets.prototype.add = function (
  ...
  if (!this.styleSheets[styleSheetName]) {
    this.styleSheets[styleSheetName] = {
      properties,
      namesInComponents: [...namesInComponents],
    ...
    this.styleSheets[styleSheetName].parentComponentNames = [
      ...this.styleSheets[styleSheetName].parentComponentNames,
      ...parentComponentNames,
    ];
  }
...
StyleSheets.prototype.markAsUsed = function (fullyQualifiedName) {
  ...
  const relatedStyleSheetEntry = Object.entries(this.styleSheets)
    .find((entry) => entry[1].namesInComponents
      && entry[1].namesInComponents.includes(styleSheetNameFromStyle)
      && entry[1].parentComponentNames.includes(parentComponentName));
